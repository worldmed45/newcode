...
<html>
    <head>
        ...
        <!--Favicon add-->
        <link rel="shortcut icon" type="image/png" href="{{asset('assets/images/logo/icon.png') }}" width="100" height="100">
        <!--bootstrap Css-->
    ...
    <nav class="navbar-area">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 ">
                    <a href="{{url('/')}}" class="logo"><img src="{{asset('assets/images/logo/logo.png') }}" width="350" height="40" alt="logo image"></a>
                </div>   
...
<div class="preloader">
    <div class="preloader-wrapper">
        <div class="preloader-img">
            <img src="{{asset('assets/images/logo/icon.png') }}" width="50" height="50" alt="*">
        </div>
    </div>
</div>
<!--preloader end-->
