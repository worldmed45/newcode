...
<li class="dropdown">
<a href="#" style="font-size: 20px; color:#fff; margin-right: 20px;">1 ETH  = {{number_format(floatval($data['TokenPerETH']) , $gnl->decimal, '.', '')}} {{$gnl->cur}}</a>
</li>
<li class="dropdown">
<a href="#" style="font-size: 20px; color:#fff; margin-right: 20px;">1 BTC  = {{number_format(floatval($data['TokenPerBTC']) , $gnl->decimal, '.', '')}} {{$gnl->cur}}</a>
</li>
<li class="dropdown">
<a href="#" style="font-size: 20px; color:#fff; margin-right: 20px;">1 LTC  = {{number_format(floatval($data['TokenPerLTC']) , $gnl->decimal, '.', '')}} {{$gnl->cur}}</a>
</li>
</ul>
