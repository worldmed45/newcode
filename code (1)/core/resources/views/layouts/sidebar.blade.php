  ...
  <div data-scrollbar="true" data-height="100%">
    ...
    <ul class="nav" style="text-transform: uppercase;">
      ...
      <li class="@if(request()->path() == 'home/referal') active @endif"><a href="{{route('referal')}}"><i class="fa fa-users" aria-hidden="true"></i> <span>Reference log</span></a></li>
       <li class="@if(request()->path() == 'home/Wallet') active @endif"><a href="{{route('Wallet')}}"><i class="fa fa-bar-chart" aria-hidden="true"></i> <span> Wallet</span></a></li>
        <li class="@if(request()->path() == 'home/Transaction') active @endif"><a href="{{route('Transaction')}}"><i class="fa fa-commenting" aria-hidden="true"></i> <span>Transaction</span></a></li>
         <li class="@if(request()->path() == 'home/buytoken') active @endif"><a href="{{route('buytoken')}}"><i class="fa fa-money" aria-hidden="true"></i> <span>Buy Token </span></a></li>
