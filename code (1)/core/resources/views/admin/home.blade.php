...
@php
   ...
   $ico_setting = \App\IcoSetting::where('id',1)->first();
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                            <div class="dashboard-stat purple">
                                ...
                                <div class="details">
                                    <div class="number">
                                        <span data-counter="" data-value="#"><?php echo $ico_setting->Token_sold;?></span>
                                    </div>
            ...
            <div class="col-md-4">
                <div class="panel panel-{{$ico->status == 1? 'success': 'warning'}}">
                        ...
                        <div class="panel-body text-center">
                            <ul class="list-group">
                                <li class="list-group-item">1 ETH Price: <strong>{{$ico->price}} {{$gnl->cur}}</strong></li>
                                ...
                                <li class="list-group-item">Sold: <strong>{{$ico_setting->Token_sold}} {{$gnl->cur}}</strong></li>
                                <li class="list-group-item">
                                      <div class="progress">
                                      <div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="{{round(($ico_setting->Token_sold/$ico->quant)*100,2)}}"
                                      aria-valuemin="0" aria-valuemax="100" style="width:{{round(($ico_setting->Token_sold/$ico->quant)*100,2)}}%">
                                      </div>
                                    </div>
                                    <span style="color:#0066cc;">{{round(($ico_setting->Token_sold/$ico->quant)*100,2)}}% Sold</span>
                                </li>
                            </ul>
                        </div>
                    </div>
