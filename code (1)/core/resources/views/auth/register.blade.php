                    ...
                    <form method="POST" action="{{ route('register') }}">
                     ...
                     <div class="row">
                            <div class="col-lg-12">
                                ...
                                <input id="mobile" type="text" placeholder="Mobile" name="mobile" value="{{ old('mobile') }}" required>

                                @if(isset($reference))
                        <input type="text" name="refer" placeholder="Refer Code" value="{{$reference}}">
                        @else
                        <input type="text" name="refer" placeholder="Refer Code" value="">
                    @endif
