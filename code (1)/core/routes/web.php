...
Route::post('/token_submit', 'HomeController@token_submit')->name('token_submit');
Route::post('/eth_submit', 'HomeController@eth_submit')->name('eth_submit');
Route::post('/btc_submit', 'HomeController@btc_submit')->name('btc_submit');
Route::post('/ltc_submit', 'HomeController@ltc_submit')->name('ltc_submit');
...
Route::post('/buy_token', 'HomeController@buy_token')->name('buy_token');
...
Route::group(['prefix' => 'admin'], function () {
  ...
  // Ico setting
  Route::get('/icosetting', 'IcosettingController@index')->name('icosetting');
  Route::post('/icosetting-update', 'IcosettingController@update')->name('icosetting.update');
  //

  Route::get('/setcrowddetting','IcosettingController@setcrowddetting')->name('setcrowddetting');
  Route::post('/setcrowddetting-tokenpereth','IcosettingController@tokenpereth')->name('setcrowddetting.tokenpereth');
  Route::post('/setcrowddetting-starttime','IcosettingController@starttime')->name('setcrowddetting.starttime');
  Route::post('/setcrowddetting-endtime','IcosettingController@endtime')->name('setcrowddetting.endtime');
  Route::post('/setcrowddetting-finalize','IcosettingController@finalize')->name('setcrowddetting.finalize');
  Route::post('/setcrowddetting-killcontract','IcosettingController@killcontract')->name('setcrowddetting.killcontract');


  // withdrawal_request

  Route::get('/withdrawal_request','Withdrawal_requestController@index')->name('withdrawal_request');
  Route::post('/withdrawal_request-automatic','Withdrawal_requestController@automatic')->name('withdrawal_request.automatic');
  Route::post('/withdrawal_request-reject','Withdrawal_requestController@reject')->name('withdrawal_request.reject');
  Route::post('/withdrawal_request-faileth','Withdrawal_requestController@faileth')->name('withdrawal_request.faileth');
   Route::post('/withdrawal_request-automatictoken','Withdrawal_requestController@automatictoken')->name('withdrawal_request.automatictoken');
  Route::post('/withdrawal_request-rejecttoken','Withdrawal_requestController@rejecttoken')->name('withdrawal_request.rejecttoken');
  Route::post('/withdrawal_request-failtoken','Withdrawal_requestController@failtoken')->name('withdrawal_request.failtoken');


  Route::post('/withdrawal_request-btcreject','Withdrawal_requestController@btcreject')->name('withdrawal_request.btcreject');
  Route::post('/withdrawal_request-ltcreject','Withdrawal_requestController@ltcreject')->name('withdrawal_request.ltcreject');
  Route::post('/withdrawal_request-btcautomatic','Withdrawal_requestController@btcautomatic')->name('withdrawal_request.btcautomatic');
  Route::post('/withdrawal_request-ltcautomatic','Withdrawal_requestController@ltcautomatic')->name('withdrawal_request.ltcautomatic');
