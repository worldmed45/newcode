...
class FrontController extends Controller
{
    ...
    $url = "https://world-meds.herokuapp.com/?task=TokenPerETH";
        ...
        return view('front.index',compact('roads','faqs','testims','services','teams','front','day','icos','ETH_raised','ico_sale_text','startsAt','endsAt','current_time','TokenRemain','countdown','text','TokenPerETH'));
    }
